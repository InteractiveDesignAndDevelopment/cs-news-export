...
component accessors=true output=false persistent=false {
  ...
  public struct function toStructForXMLExport () {
    ...
    // Avoid confusion; summary tags are generated by the _.cfm toXml function
    s['excerpt']    = encodeForXML(getSummary());
    s['title']      = encodeForXML(getTitle());
    // Avoid confusion; taxonomy tags are generated by teh _.cfm toXml function
    s['categories'] = encodeForXML(taxonomyList());
